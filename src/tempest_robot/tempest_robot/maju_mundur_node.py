...
def servo_calculation(yaw, pitch, jarak, angle):
...
class MyNode(Node):
    def __init__(self):
        ...
        self.subscriber_data = self.create_subscription(Int32MultiArray, "/maju_mundur", self.fungsi_, 1)
    ...
    def fungsi_(self, message = Int32MultiArray):
      ...
      info.data = servo_calculation() #tambahin
